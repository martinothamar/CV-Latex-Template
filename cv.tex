...
\begin{aside}
  ...
  \section{Web \& Git}
	...
	\vspace{0.10cm}
    \underline{\href{http://stackoverflow.com/story/martinothamar}{stackoverflow.com/story}}
	\vspace{0.10cm}
    \underline{\href{http://stackoverflow.com/cv/martinothamar}{stackoverflow.com/cv}}
	\vspace{0.10cm}
...
\begin{entrylist}
  \entry
    ...
    framework and passport.js authentication library.
